...
<body style="color: black;background-image: url(police.png);background-size: 100%;background-repeat: no-repeat;">
 ...
 <div align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h3 style="color:white">Police ID</h3></label>

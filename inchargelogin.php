...
<body style="color: black;background-image:url('jail.png');background-size: 100%;background-repeat: no-repeat;back">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h3 style="color:white">Incharge Id</h3></label>

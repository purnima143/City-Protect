...
<body style="background-color: #dfdfdf!important">
              ...
              <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li ><a href="complainer_page.php"> New Complaint</a></li>
    ...
    <div>
        <form style="float: right; margin-right: 100px; margin-top: 6%;" method="post">
            ...
            <input class="btn" type="submit" value="Search" style="margin-top:2px; margin-left:20px;background-color: rgb(3, 12, 61); color: white;" name="s2">
        </form>
    </div>
    ...
    <div style="padding:10%;">
      <table class="table table-bordered">
       <thead class="thead-dark" style="background-color: rgb(3, 12, 61); color: white;">
         <tr>

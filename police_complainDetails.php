...
<div style="padding:7%; margin-top:10px;">
...
<div style="padding:4%; margin-top:8px;">
   <table class="table table-bordered">
        <thead class="thead-dark" style="background-color: black; color: white;">
    <tr>
...
?>
  ...
  <div style="width: 100%; height: 250px; "> 
    ...
    <div style="width: 50%;float: left;height: 250px; background-color: #eee"> 
     
     <form method="post">
    
      <h5 style="text-align: center;color:rgb(3,19,61); padding-top:2%;"><b>Complaint ID</b></h5>                 
      <input type="text" name="cid" style="margin-left: 47%; width: 50px;background:rgb(3,19,61);" disabled value="<?php echo "$cid" ?>">
     ...
     <form method="post">
     <textarea name="final_report" cols="40" rows="5" placeholder="Final Report" style="margin-top: 20px;margin-left: 20px;color:black;" id="ciid" onfocusout="f1()" required></textarea>
     <div>
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>City-Protect</b></h4>
</div> 

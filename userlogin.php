...
<body style="background-size: cover;
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php" style="margin-top: 5%;"><b>City-Protect</b></a>
    </div>
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"><h3 style="color: #fff;">User ID</h3></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h3 style="color: #fff;">Password</h3></label>
